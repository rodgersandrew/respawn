...
export default class PostReasonModal extends React.Component {
  render() {
    return (
      <Modal
        animationType='fade'
          ...
          {insets => (
            <View
              ...
              <View
                ...
                <Button
                  onPress={() =>
                    this.props.reportPost(this.props.post.postID, 'Nudity')
                  }
                  title='Nudity'
                ...
                <Button
                  onPress={() =>
                    this.props.reportPost(this.props.post.postID, 'Gore')
                  }
                  title='Gore'
                  titleStyle={styles.defaultTitleStyle}
                  buttonStyle={styles.buttonStyle}
                ...
                <Button
                  onPress={() =>
                    this.props.reportPost(this.props.post.postID, 'Hate Speech')
                  }
                  title='Hate Speech'
                  titleStyle={styles.defaultTitleStyle}
                  buttonStyle={styles.buttonStyle}
                ...
                <Button
                  onPress={() =>
                    this.props.reportPost(this.props.post.postID, 'Spam')
                  }
                  title='Spam'
                  titleStyle={styles.defaultTitleStyle}
                  buttonStyle={styles.buttonStyle}
