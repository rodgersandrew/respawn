...
class BrowseAllScreen extends Component {
  ...
  _loadMorePosts = createdAt => {
    this.props.getCollectivePosts(createdAt);
  };
...
export default connect(mapStateToProps, actions)(BrowseAllScreen);
